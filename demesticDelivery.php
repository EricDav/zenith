<html lang="en-US" class="csstransforms csstransforms3d csstransitions js_active  vc_desktop  vc_transform  vc_transform " style="height: 100%;">
  ...
  <body class="service-template-default single single-service postid-215 preview1 wpb-js-composer js-comp-ver-6.6.0 vc_responsive" style="position: relative; min-height: 100%; top: 0px;">
      ...
      <div id="wrapper">
         ...
         <!-- header close -->
         <!-- subheader begin -->
         <section id="subheader" class="no-bottom" data-stellar-background-ratio="0.5" style="background-position: 50% 0px;">
            <div class="overlay">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <h1>DOMESTIC DELIVERIES <span>Secure &amp; Reliable</span></h1>
         ...
         <div id="content" class="no-padding">
            <section class="wpb_row vc_row-fluid side-bg">
               <div class="image-container col-md-6 col-md-offset-6 pull-right">
                  <div class="background-image" style="background: url(https://www.zenithlogisticservices.com/wp-content/uploads/2016/01/domestic_deliveries.png) ;"></div>
               </div>
               <div class="container">
                  <div class="row">
                           ...
                           <div class="wpb_wrapper wow fadeInRight" data-wow-delay=".5s" data-wow-duration=".8s" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.5s; animation-name: fadeInRight;">
                              <div class="wpb_text_column wpb_content_element ">
                                 <div class="wpb_wrapper">
                                    <p>At Zenith Logistics Service, we’re more than a delivery network, we’re a business partner. That’s why we work closely with our customers to design Adaptive Delivery Solutions that align with business goals and boost bottom lines.</p>
                                    <p>Customers know they can count on the Zenith Logistics Service team to connect them with a network of reliable independent professionals to get their packages, documents, and media where they need to be in the most effective, efficient and secure way possible.</p>
                                    ...
                                    <p>Wherever your packages need to be, our express same-day logistics solutions will make sure they arrive safely and securely, on-time and on-budget. With&nbsp;Zenith Express Courier Service, it’s routed delivery with business impact.</p>
                                 </div>
                              </div>
                           </div>
                        </div>
            ...
            <section class="wpb_row vc_row-fluid call-to-action vc_custom_1452680896386 vc_row-has-fill">
               <div class="container">
                  <div class="row">
                     ...
                     <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-3">
                        <div class="vc_column-inner ">
                           <div class="wpb_wrapper  ">			
                              <a class=" btn-border-light " href="http://demo.vegatheme.com/gocargo/contact/" title="Contact Us" target="_self">Contact Us</a>	
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="container">
                  <div class="row">
                        ...
                        <div class="vc_column-inner vc_custom_1452746710490">
                           <div class="wpb_wrapper  ">
                              <div class="text-center">
                                 <h2 class="heading wow fadeInUp" data-wow-delay="0" style="visibility: hidden; animation-name: none;">Warehousing FAQ <strong>Frequently Asked Questions</strong></h2>
                                 <div class="small-border wow flipInY" data-wow-delay=".2s" data-wow-duration=".8s" style="visibility: hidden; animation-duration: 0.8s; animation-delay: 0.2s; animation-name: none;"></div>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-6">
                        <div class="vc_column-inner ">
                           <div class="wpb_wrapper wow fadeInLeft " style="visibility: hidden; animation-name: none;">
                     ...
                     <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-6">
                        <div class="vc_column-inner ">
                           <div class="wpb_wrapper wow fadeInRight " style="visibility: hidden; animation-name: none;">
                              <div class="vc_tta-container" data-vc-action="collapseAll">
                                 <div class="vc_general vc_tta vc_tta-accordion vc_tta-color-sky vc_tta-style-flat vc_tta-shape-square vc_tta-o-shape-group vc_tta-controls-align-left vc_tta-o-all-clickable  bg_transparent">
                                    <div class="vc_tta-panels-container">
                                       <div class="vc_tta-panels">

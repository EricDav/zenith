<html lang="en-US" class="csstransforms csstransforms3d csstransitions js_active  vc_desktop  vc_transform  vc_transform " style="height: 100%;">
   ...
   <body class="service-template-default single single-service postid-194 preview1 wpb-js-composer js-comp-ver-6.6.0 vc_responsive" style="position: relative; min-height: 100%; top: 0px;">
         ...
         <section id="subheader" class="no-bottom" data-stellar-background-ratio="0.5" style="background-position: 50% 0px;">
            <div class="overlay">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <h1>Logistics <span>Secure &amp; Reliable</span></h1>
         ...
         <div id="content" class="no-padding">
            <section class="wpb_row vc_row-fluid side-bg">
               <div class="image-container col-md-6 col-md-offset-6 pull-right">
                  <div class="background-image" style="background: url(https://www.zenithlogisticservices.com/wp-content/uploads/2016/01/bg_service_details_1.jpg) ;"></div>
               </div>
               <div class="container">
                  <div class="row">
                        ...
                        <div class="vc_column-inner vc_custom_1452746710490">
                           <div class="wpb_wrapper  ">
                              <div class="text-center">
                                 <h2 class="heading wow fadeInUp" data-wow-delay="0" style="visibility: visible; animation-name: fadeInUp;">Logistics FAQ <strong>Frequently Asked Questions</strong></h2>

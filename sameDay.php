<html lang="en-US" class="csstransforms csstransforms3d csstransitions js_active  vc_desktop  vc_transform  vc_transform " style="height: 100%;">
   ...
   <body class="service-template-default single single-service postid-214 preview1 wpb-js-composer js-comp-ver-6.6.0 vc_responsive" style="position: relative; min-height: 100%; top: 0px;">
         ...
         <section id="subheader" class="no-bottom" data-stellar-background-ratio="0.5" style="background-position: 50% 0px;">
            <div class="overlay">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <h1>SAME DAY DELIVERIES <span>Secure &amp; Reliable</span></h1>
         ...
         <div id="content" class="no-padding">
            <section class="wpb_row vc_row-fluid side-bg">
               <div class="image-container col-md-6 col-md-offset-6 pull-right">
                  <div class="background-image" style="background: url(https://www.zenithlogisticservices.com/wp-content/uploads/2016/01/same_day_deliveries.png) ;"></div>
               </div>
               <div class="container">
                  <div class="row">
                           ...
                           <div class="wpb_wrapper wow fadeInRight" data-wow-delay=".5s" data-wow-duration=".8s" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.5s; animation-name: fadeInRight;">
                              <div class="wpb_text_column wpb_content_element ">
                                 <div class="wpb_wrapper">
                                    <div class="elementor-element elementor-element-04e0c90 elementor-widget elementor-widget-text-editor" data-id="04e0c90" data-element_type="widget" data-widget_type="text-editor.default">
                                       <div class="elementor-widget-container">
                                          <div class="elementor-text-editor elementor-clearfix">
                                             ...
                                             <p>With proven sorting and package handling processes and highly secure facilities, our customers can count on minimal claims and damages while maximizing the positive impact to their delivery operation and bottom line.&nbsp; Some of the benefits our customers achieve from our crossdocking services include:</p>
                                             <p>&nbsp;</p>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="elementor-element elementor-element-73dd5a8 elementor-widget elementor-widget-text-editor" data-id="73dd5a8" data-element_type="widget" data-widget_type="text-editor.default">
                                       <div class="elementor-widget-container">
                                          <div class="elementor-text-editor elementor-clearfix">
                                             <ul>
                                                <li>Reduced storage costs</li>
                                                <li>Enhanced labor utilization</li>
                                                <li>Increased fill rates</li>
                                                <li>Operational efficiency</li>
                                                <li>Minimal claims and damages</li>
                                                <li>Faster delivery turnaround</li>
                                             </ul>
                                          </div>
                                       </div>
                                    </div>
                        ...
                        <div class="vc_column-inner vc_custom_1452746710490">
                           <div class="wpb_wrapper  ">
                              <div class="text-center">
                                 <h2 class="heading wow fadeInUp" data-wow-delay="0" style="visibility: visible; animation-name: fadeInUp;">Custom Brokerage FAQ <strong>Frequently Asked Questions</strong></h2>
